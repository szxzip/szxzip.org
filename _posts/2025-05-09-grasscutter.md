...
3. 克隆[Kei-Luna/LunaGC_5.3.0](https://github.com/Kei-Luna/LunaGC_5.3.0)到本地，并按照readme进行编译；
...
[^1]: [blog.chyk.ink](https://blog.chyk.ink/2022/05/01/grasscutter-on-archlinux/#安装证书)
