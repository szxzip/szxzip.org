...
申请电台执照，各地情况不同。理想状态下是省际（全国）通联，然而很多地方对省际的审查非常严格（写情况说明、提供通联、活动和获奖记录，或直接一律拒绝申请），以至于 A 类执照几乎不可能申请省际。除此之外还有概率遇到不能设置 430 MHz 、外地人不能申请等限制。另外要注意的是，申请执照要与中修官员接触，所以不用惊讶态度恶劣、吃拿卡要等现象。
